...
# metadata
pdf.set_title(title)
pdf.set_author('YunSeo Cho')

# Create Links
website = 'https://www.washingtonpost.com/opinions/2020/04/03/10-days-later-he-was-gone-readers-share-their-personal-stories-about-covid-19/'
...
pdf.print_chapter(1, 'Random Emergency No.1', '/Users/oooya/Desktop/Web/python/data/chp1.txt', ch1_link)
pdf.print_chapter(2, 'Random Emergency No.2', '/Users/oooya/Desktop/Web/python/data/chp2.txt', ch2_link)

pdf.output('/Users/oooya/Desktop/Web/python/pdf_1_yun.pdf')
